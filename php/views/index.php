...
<section class="hero">
    <div class="hero-content">
        <h1>Objevte kouzlo<br><span>domácí kuchyně</span></h1>
        <p>Najděte inspiraci mezi stovkami receptů pro každou příležitost.</p>
        <a href="recepty.php" class="btn-primary">Procházet všechny recepty →</a>
    </div>
</section>
...
<section class="add-recipe-cta">
    <div class="add-recipe-inner">
        <div class="add-recipe-text">
            ...
            <p>Máš oblíbený recept? Přidej ho a inspiruj ostatní.</p>
        </div>
