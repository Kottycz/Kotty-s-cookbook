...
<main>
    <div class="add-recipe-container">
        <h1>Přidat recept do knihovny</h1>
        <p style="color:#888;margin-top:-8px;margin-bottom:24px;">Recept bude uložen jako soukromý. Můžeš ho kdykoli navrhnout ke zveřejnění.</p>
...
Dusíme 90 minut.</pre>
        ...
        <form class="recipe-form" method="post" id="recipe-form" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <small>Nechej obojí prázdné pro výchozí obrázek. Max 5 MB (JPG, PNG, WebP, GIF).</small>
            ...
            <fieldset>
                ...
                <textarea id="steps" name="steps" rows="8"
                          placeholder="Smíchejte mouku s vejci.&#10;Přidejte mléko a promíchejte." required><?= htmlspecialchars($_POST['steps'] ?? '') ?></textarea>
            </fieldset>

            <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap;">
                <button type="submit" class="btn-submit">Uložit do knihovny</button>
